...
@Slf4j
public class FundAccountDelCHInitTest {

    public static List<String> directSaleTenantIds = Stream.of("2").collect(Collectors.toList());
    ...
    //初始化
    @Test
    public void initCHFundPool() throws Exception {
    ...
    @Test
    public void init_ch_stack1() {
        int_directSale_stack(DateUtils.parseDate("2021-08-24 15:37:53"), DateUtils.parseDate("2021-09-01 00:00:00"));
    }

    @Test
    public void init_ch_stack2() {
        int_directSale_stack(DateUtils.parseDate("2021-09-01 00:00:00"), DateUtils.parseDate("2021-09-05 00:00:00"));
    }

    @Test
    public void init_ch_stack3() {
        int_directSale_stack(DateUtils.parseDate("2021-09-05 00:00:00"), DateUtils.parseDate("2021-09-10 00:00:00"));
    }

    @Test
    public void init_ch_stack4() {
        int_directSale_stack(DateUtils.parseDate("2021-09-10 00:00:00"), DateUtils.parseDate("2021-09-13 00:00:00"));
    }

    @Test
    public void init_ch_stack5() {
        int_directSale_stack(DateUtils.parseDate("2021-09-13 00:00:00"), DateUtils.parseDate("2021-09-15 00:00:00"));
    }

    private void int_directSale_stack(Date startTime, Date endTime) {
