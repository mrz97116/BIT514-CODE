...
@Data
public class GetActualDelivery {
    private String billOfLadingNo; //提货单号
    private String mainId; //提货单号
    private String stockOutNoteNo; //实提单号
    private String stockOutDate; //出库时间
