<template>
  <global-layout @dynamicRouterShow="dynamicRouterShow" @selectTenant="selectTenant">
    <!-- update-begin- author:sunjianlei --- date:20191009 --- for: 提升右键菜单的层级 -->
    <contextmenu ref="contextmenu" :itemList="menuItemList" :visible.sync="menuVisible" style="z-index: 9999;" @select="onMenuSelect"/>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      selectTenant() {
        if(this.activePage!== indexKey) {
          this.closeOthers(indexKey)
        }
      },
