...
export default {
  ...
  data() {
    return {
      ...
      url: common.reportUrl +'/webroot/decision/view/report?viewlet=SMS_ZX%252FSM%252FSH%252FfinanceStockBalance.cpt&ref_t=design&ref_c=58bddb71-4741-4221-b174-19415ca7de01'
    }
  },
  mounted(){
    /**
