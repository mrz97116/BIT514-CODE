...
export default {
  name: 'coldRollPurchaseSaleInventory',
  data() {
    return {
      ...
      url: common.reportUrl +'/webroot/decision/view/report?viewlet=SMS_ZX%252FSM%252FSH%252FcoldRollPurchaseSaleInventory.cpt&ref_t=design&ref_c=af3a5a30-0500-4469-b175-51d2358e17a2'
    }
  },
  mounted(){
    /**
