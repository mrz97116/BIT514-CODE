  ...
  export default {
    ...
    data() {
      return {
        ...
        url: common.reportUrl +'/webroot/decision/view/report?viewlet=SMS_ZX%252FSM%252FYRM%252Finventory_man.cpt&ref_t=design&ref_c=3000de37-6032-4f37-81b5-4aef227dd0b6'
