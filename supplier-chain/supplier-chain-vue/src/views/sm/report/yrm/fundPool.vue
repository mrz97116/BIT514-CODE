...
//        url: common.reportUrl +'/webroot/decision/view/report?viewlet=SMS_ZX%252FSM%252FYRM%252Finventory.cpt&ref_t=design&ref_c=0412a57b-e6aa-4f6c-87f3-0ba051e6f645'
        url: common.reportUrl + '/webroot/decision/view/report?viewlet=SMS_ZX%252FSM%252FYRM%252Ffundpool.cpt&ref_t=design&ref_c=6fa38768-8e55-4ea4-981b-b4ae367f2106&tenant_id=' + this.$ls.get("TENANT_ID")
      }
    },
    mounted(){
      /**
