...
export default {
  ...
  data() {
    return {
      ...
      url: common.reportUrl +'/webroot/decision/view/report?viewlet=SMS_ZX%252FSM%252FYRM%252FsalesOrderDet.cpt&ref_t=design&ref_c=63a7eee3-43f5-4b04-b929-acc47d67249d'
    }
  },
  mounted(){
    /**
