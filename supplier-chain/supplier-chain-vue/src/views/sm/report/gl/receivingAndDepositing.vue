...
export default {
  ...
  data() {
    return {
      ...
      url: common.reportUrl +'/webroot/decision/view/report?viewlet=SMS_ZX%252FSM%252FGL%252FreceivingAndDepositing.cpt&ref_t=design&ref_c=df5996c4-51bf-4388-894f-e5ba1f9bbf72&tenant_id='+ this.$ls.get("TENANT_ID")
