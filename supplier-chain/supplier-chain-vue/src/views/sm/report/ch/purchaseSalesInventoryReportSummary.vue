...
export default {
  ...
  data() {
    return {
      ...
      //http://172.16.5.88/webroot/decision/view/report?viewlet=SMS_ZX%252FSM%252FCH%252FPurchaseSalesInventorySummary.cpt&ref_t=design&ref_c=47e2891f-7445-4226-af2f-5db9cfa519ca
      url: common.reportUrl +'/webroot/decision/view/report?viewlet=SMS_ZX%252FSM%252FCH%252FPurchaseSalesInventorySummary.cpt&ref_t=design&ref_c=47e2891f-7445-4226-af2f-5db9cfa519ca'
