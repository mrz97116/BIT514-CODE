...
export default {
  ...
  data() {
    return {
      ...
      url: common.reportUrl +'/webroot/decision/view/report?viewlet=SMS_ZX%252FSM%252FCH%252FfinanceStockBalance.cpt&ref_t=design&ref_c=7a2c13f6-6273-4df4-8ae3-d0f4d1dc4188'
    }
  },
  mounted(){
    /**
