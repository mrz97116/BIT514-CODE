...
export default {
  ...
  data() {
    return {
      ...
      url: common.reportUrl +'/webroot/decision/view/report?viewlet=SMS_ZX%252FSM%252FCH%252FsalesOrderDet.cpt&ref_t=design&ref_c=c07d6e19-3763-42fe-96dd-40e60c17e92c'
    }
  },
  mounted(){
    /**
