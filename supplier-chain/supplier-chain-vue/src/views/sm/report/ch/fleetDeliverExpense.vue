...
export default {
  name: 'FleetDeliverExpenseReport',
  data() {
    return {
      ...
      url: common.reportUrl +'/webroot/decision/view/report?viewlet=SMS_ZX%252FSM%252FCH%252FfleetDeliverExpense.cpt&ref_t=design&ref_c=41140f0e-a25f-4bc6-adc6-014795d1ce40'
