...
export default {
  ...
  data() {
    return {
      ...
      url: common.reportUrl +'/webroot/decision/view/report?viewlet=SMS_ZX%252FSM%252FCH%252FaverageCost.cpt&ref_t=design&ref_c=b1c90bc4-986e-4934-b581-9f2f8a69027b'
    }
  },
  mounted(){
    /**
