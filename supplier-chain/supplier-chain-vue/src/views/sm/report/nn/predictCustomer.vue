...
<script>
  ...
  export default {
    ...
    data() {
      return {
        url: common.reportUrl +'/webroot/decision/view/report?viewlet=SMS_ZX%252FFM%252FNN%252FpredictCustomer.cpt&ref_t=design&ref_c=9b947c74-2dcd-4caf-b6fa-33adfabfd1d0'
