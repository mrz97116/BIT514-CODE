  ...
  export default {
    ...
    data() {
      return {
        ...
        url: common.reportUrl +'/webroot/decision/view/report?viewlet=SMS_ZX%252FFM%252FNN%252FsettledForm.cpt&ref_t=design&ref_c=cbbdc891-14a8-4f68-a945-e26bea31d303'
