...
//        url: common.reportUrl +'/webroot/decision/view/report?viewlet=SMS_ZX%252FSM%252FYRM%252Finventory.cpt&ref_t=design&ref_c=0412a57b-e6aa-4f6c-87f3-0ba051e6f645'
          url: common.reportUrl + '/webroot/decision/view/report?viewlet=SMS_ZX%252FSM%252FcashSummary.cpt&ref_t=design&ref_c=830d7dd8-4c87-4cb8-b2bd-566f06bc08ba&tenant_id=' + this.$ls.get("TENANT_ID")
      }
    },
    mounted(){
      /**
