...
export default {
  ...
  data() {
    return {
      ...
      url: common.reportUrl +'/webroot/decision/view/report?viewlet=SMS_ZX%252FSM%252FGD%252FreceivingAndDepositing.cpt&ref_t=design&ref_c=a7570a68-f4e5-4f1b-a105-c4397fe4b2be&tenant_id=' + this.$ls.get("TENANT_ID")
