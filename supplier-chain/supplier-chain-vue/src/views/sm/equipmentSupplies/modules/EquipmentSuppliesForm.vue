        ...
        <a-row>
          ...
          <a-col :span="24">
            <a-form-item label="顾客名称" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['customer']" placeholder="请输入顾客名称"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="24">
            <a-form-item label="状态" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-dict-select-tag type="list" v-decorator="['status']" :trigger-change="true" dictCode="settle_status" placeholder="请选择状态"/>
            </a-form-item>
          </a-col>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/sm/equipmentSupplies/add",
          edit: "/sm/equipmentSupplies/edit",
          queryById: "/sm/equipmentSupplies/queryById"
        }
      }
    },
    computed: {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'orderNo','totalPrice','tenantId','delFlag','customer','status'))
        })
      },
      //渲染流程表单数据
      showFlowData(){
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'orderNo','totalPrice','tenantId','delFlag','customer','status'))
      },
    }
  }
</script>