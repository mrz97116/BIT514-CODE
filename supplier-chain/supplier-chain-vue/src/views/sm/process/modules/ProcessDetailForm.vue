      ...
      <j-form-container :disabled="formDisabled">
        <a-form :form="form">
          <a-row>
            ...
            <a-col :span="8">
              <a-form-item label="材料件数（根数）" :labelCol="labelCol" :wrapperCol="wrapperCol">
...
export default {
  ...
  methods: {
    edit(record) {
      ...
      this.visible = true
      this.$nextTick(() => {
        this.form.setFieldsValue(pick(this.model, 'sgSign', 'prodCode', 'prodCname', 'prodClassCode', 'prodCnameOther', 'matStatus', 'stockType', 'matNo', 'matActWt', 'matNetWt', 'matDiscrepWt', 'matNum', 'matKind', 'availableWeight', 'availableQty', 'preuseQty', 'preuseWeight', 'matLen', 'matWidth', 'matThick', 'matActLen', 'matActWidth', 'matActThick', 'custMatSpecs', 'dealerId', 'purchasePrice', 'technicalStandard', 'addType', 'rawMaterialNo'))
      })
    },
    handleOk(){
      this.visible = false
