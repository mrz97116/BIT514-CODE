  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/sm/dischargerInfo/add",
          edit: "/sm/dischargerInfo/edit",
          queryById: "/sm/dischargerInfo/queryById"
        }
      }
    },
    computed: {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'delFlag','tenantId','dischargerName'))
        })
      },
      //渲染流程表单数据
      showFlowData(){
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'delFlag','tenantId','dischargerName'))
      },
    }
  }
</script>