<template>
  <a-card :bordered="false">
    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="提单生成标识">
              <a-input placeholder="请输入提单生成标识" v-model="queryParam.prepareOrderStatus"></a-input>
            </a-form-item>
          </a-col>
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('预开单信息表')">导出</a-button>
    ...
    <prepare-order-modal ref="modalForm" @ok="modalFormOk"></prepare-order-modal>
  </a-card>
</template>
