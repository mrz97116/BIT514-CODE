...
//        url: common.reportUrl +'/webroot/decision/view/report?viewlet=SMS_ZX%252FSM%252FYRM%252Finventory.cpt&ref_t=design&ref_c=0412a57b-e6aa-4f6c-87f3-0ba051e6f645'
        url: common.reportUrl + '/webroot/decision/view/report?viewlet=SMS_ZX%252FFM%252FYRM%252FcashSummary.cpt&ref_t=design&ref_c=bf7576f4-3c7e-4f8c-9c31-0f6207e6d69c&tenant_id=' + this.$ls.get("TENANT_ID")
      }
    },
    mounted(){
      /**
