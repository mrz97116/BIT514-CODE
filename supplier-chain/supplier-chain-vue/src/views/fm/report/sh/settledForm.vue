  ...
  export default {
    ...
    data() {
      return {
        ...
        url: common.reportUrl +'/webroot/decision/view/report?viewlet=SMS_ZX%252FFM%252FSH%252FsettledForm.cpt&ref_t=design&ref_c=5de04a4e-6cf2-4c84-a263-974005d516f9'
