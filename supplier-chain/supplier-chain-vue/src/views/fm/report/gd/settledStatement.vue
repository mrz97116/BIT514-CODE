  ...
  export default {
    ...
    data() {
      return {
        ...
        url: common.reportUrl +'/webroot/decision/view/report?viewlet=SMS_ZX%252FFM%252FGD%252Fsettle.cpt&ref_t=design&ref_c=bf7576f4-3c7e-4f8c-9c31-0f6207e6d69c&tenant_id='+this.$ls.get("TENANT_ID")
