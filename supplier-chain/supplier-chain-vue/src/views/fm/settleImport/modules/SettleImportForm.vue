        ...
        <a-row>
          ...
          <a-col :span="24">
            <a-form-item label="提单编号" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['saleBillNo']" placeholder="请输入提单编号"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-item label="产地" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['placeOfOrigin']" placeholder="请输入产地"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-item label="出库类型" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['outType']" placeholder="请输入出库类型"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="24">
            <a-form-item label="装车单编号" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['stockNo']" placeholder="请输入装车单编号"></a-input>
            </a-form-item>
          </a-col>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/fm/settleImport/add",
          edit: "/fm/settleImport/edit",
          queryById: "/fm/settleImport/queryById"
        }
      }
    },
    computed: {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'tenantId','delFlag','stockId','saleBillNo','prodCname','carNo','custMatSpecs','placeOfOrigin','qty','weight','sgSign','outType','stockNo'))
        })
      },
      //渲染流程表单数据
      showFlowData(){
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'tenantId','delFlag','stockId','saleBillNo','prodCname','carNo','custMatSpecs','placeOfOrigin','qty','weight','sgSign','outType','stockNo'))
      },
    }
  }
</script>