<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          ...
          <template v-if="toggleSearchStatus">
            ...
            <a-col :xl="10" :lg="11" :md="12" :sm="24">
              <a-form-item label="电文接收时间">
                <j-date placeholder="请选择开始时间" class="query-group-cust" v-model="queryParam.msgRecvTimeStart" :showTime="true" dateFormat="YYYY-MM-DD HH:mm:ss"/>
                <span class="query-group-split-cust"></span>
                <j-date placeholder="请选择结束时间" class="query-group-cust" v-model="queryParam.msgRecvTimeEnd" :showTime="true" dateFormat="YYYY-MM-DD HH:mm:ss"/>
              </a-form-item>
            </a-col>
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
    ...
    <div class="table-operator">
      <a-button @click="handleReRecv" type="primary" icon="reload">重收电文</a-button>
    </div>
    ...
    <msg-recv-info-modal ref="modalForm" @ok="modalFormOk"></msg-recv-info-modal>
  </a-card>
</template>
...
<script>
  ...
  import MsgRecvInfoModal from './modules/MsgRecvInfoModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/msg/info/recv/findList",
          reRecv: "/msg/info/recv/reRecv",
        },
        dictOptions:{},
      }
    },
    ...
    methods: {
      ...
      handleReRecv(){
        ...
        postAction(this.url.reRecv, this.selectionRows).then((res) => {
          if (res.success) {
