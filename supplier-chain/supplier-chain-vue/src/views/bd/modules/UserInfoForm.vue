  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/bd/userInfo/add",
          edit: "/bd/userInfo/edit",
          queryById: "/bd/userInfo/queryById"
        }
      }
    },
    computed: {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'userId','idCard','phone','userName'))
        })
      },
      //渲染流程表单数据
      showFlowData(){
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'userId','idCard','phone','userName'))
      },
    }
  }
</script>