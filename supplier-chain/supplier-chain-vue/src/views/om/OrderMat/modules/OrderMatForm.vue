        ...
        <a-row>
          ...
          <a-col :span="12">
            <a-form-item label="物料种类" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-dict-select-tag type="list" v-decorator="['matKind', validatorRules.matKind]" :trigger-change="true" dictCode="mat_kind" placeholder="请选择物料种类"/>
            </a-form-item>
          </a-col>
          <a-col :span="12">
          ...
          <a-col :span="12">
            <a-form-item label="单重" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input-number v-decorator="['pieceWeight', validatorRules.price]" placeholder="请输入单重" style="width: 100%"/>
            </a-form-item>
          </a-col>
          <a-col :span="12">
            <a-form-item label="计重方式" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-dict-select-tag type="radio" v-decorator="['wtMethodCode',validatorRules.wtMethodCode]" :trigger-change="true" dictCode="wt_method_code" placeholder="请选择计重方式"/>
            </a-form-item>
          </a-col>
          <a-col :span="12">
          ...
          <a-col :span="12">
            <a-form-item label="钝化方式" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['surfaceTreatment']" placeholder="请输入钝化方式" style="width: 100%"/>
            </a-form-item>
          </a-col>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/om/orderMat/add",
          edit: "/om/orderMat/edit",
          queryById: "/om/orderMat/queryById"
        }
      }
    },
    computed: {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'prodCname','prodCnameOther','matKind','sgSign','weight','price','pieceWeight','wtMethodCode','prodClassCode','matThick','matWidth','matLen','surfaceTreatment'))
        })
      },
      //渲染流程表单数据
      showFlowData(){
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'prodCname','prodCnameOther','matKind','sgSign','weight','price','pieceWeight','wtMethodCode','prodClassCode','matThick','matWidth','matLen','surfaceTreatment'))
      },
    }
  }
</script>