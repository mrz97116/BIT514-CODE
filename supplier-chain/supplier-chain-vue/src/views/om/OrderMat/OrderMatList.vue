<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <!--<a-button type="primary" icon="download" @click="handleExportXls('订单物料信息表')">导出</a-button>-->
...
<!--          </a-dropdown>-->
    ...
    <order-mat-modal ref="modalForm" @ok="modalFormOk"></order-mat-modal>
  </a-card>
</template>
...
<script>
  ...
  import OrderMatModal from './modules/OrderMatModal'
      ...
      return {
        ...
        columns: [
          ...
          },
          {
            title:'计重方式',
            align:"center",
            dataIndex: 'wtMethodCode_dictText'
          },
          {
            title:'产品大类',
            align:"center",
        ...
        url: {
          list: "/om/orderMat/list",
          delete: "/om/orderMat/delete",
          deleteBatch: "/om/orderMat/deleteBatch",
          exportXlsUrl: "/om/orderMat/exportXls",
          importExcelUrl: "om/orderMat/importExcel",
